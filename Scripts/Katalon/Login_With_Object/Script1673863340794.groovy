...
WebUI.setText(findTestObject('Object Repository/Page_Sign in  Katalon Software Quality Mana_cfddb7/input_Welcome back_user_email'), 
    GlobalVariable.username_Katalon,GlobalVariable.username1)

WebUI.setText(findTestObject('Object Repository/Page_Sign in  Katalon Software Quality Mana_cfddb7/input_Valid email is required to activate p_255484'), 
    GlobalVariable.pass_kognivera,GlobalVariable.pass1)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_My Organization_01 - Katalon TestOps/span_SJ'), 0)
